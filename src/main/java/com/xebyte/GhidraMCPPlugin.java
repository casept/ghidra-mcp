...
import com.xebyte.core.ProjectVersionControlService;
...
public class GhidraMCPPlugin extends Plugin implements ApplicationLevelPlugin {
    ...
    private void startServer() throws IOException {
        ...
        ProjectVersionControlService projectVersionControlService = new ProjectVersionControlService(tool);
        ...
        // ==========================================================================
        // /server/* endpoints — now registered via ProjectVersionControlService
        // (annotation-scanned above). Only /server/authenticate remains manual.
        // ==========================================================================
 ...
 */
    ...
    // PROJECT VERSION CONTROL — extracted to core/ProjectVersionControlService.java
    // ==========================================================================
    ...
    private String getProjectInfo() {
        ...
        RepositoryAdapter repo = null;
        try {
            java.lang.reflect.Method m = data.getClass().getMethod("getRepository");
            repo = (RepositoryAdapter) m.invoke(data);
        } catch (Exception e) { /* no repo */ }
        StringBuilder sb = new StringBuilder();
